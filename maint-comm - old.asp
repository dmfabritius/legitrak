...
<%
	If CustomerID <> 1 And CustomerID <> 41 And CustomerID <> 231 And CustomerID <> 232 Then Response.Redirect "errors/403-17.htm"
...
<select name=CommID style='width:250' onchange='cdf.cdfSubmit.disabled=true'>
...
<option value=House <%=House%>>House<option value=Senate<%=Senate%>>Senate</select></td>
